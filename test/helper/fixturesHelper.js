    ...
    return function () {
        return new Promise(function (resolve, reject) {
            try {
                ...
                fs.copySync(path.join(base, 'vendor'), path.join(target, 'vendor'));
                fs.copySync(path.join(base, 'composer.lock'), path.join(target, 'composer.lock'));
                fs.copySync(path.join(base, 'composer.json'), path.join(target, 'composer.json'));
