...
describe('symfony generator (grunt)', function () {
  ...
  it('', all({buildtool: 'grunt', loader: 'browserify', preprocessor: 'less'}));
  ...
  it('', some({buildtool: 'grunt', loader: 'jspm', framework: 'uikit', preprocessor: 'less'}));
  // It('', all({buildtool: 'grunt', loader: 'jspm', framework: 'uikit', preprocessor: 'sass', libsass: false}));
  it('', all({buildtool: 'grunt', loader: 'jspm', framework: 'uikit', preprocessor: 'sass', libsass: true}));
  ...
  it('', some({buildtool: 'grunt', loader: 'webpack', framework: 'foundation', preprocessor: 'sass', libsass: true}));
  it('', all({buildtool: 'grunt', loader: 'webpack', framework: 'foundation', preprocessor: 'stylus'}));
});
